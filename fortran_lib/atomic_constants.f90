...
! define real(dp) numerical constants
     real(dp), public, parameter :: dpi   = dacos(-1.0d0)
     real(dp), public, parameter :: dzero = 0.0_dp
     real(dp), public, parameter :: dhalf = 0.5_dp
     real(dp), public, parameter :: done  = 1.0_dp
     real(dp), public, parameter :: dtwo  = 2.0_dp
...
! define complex(dp) numerical constants
     ...
     complex(dp), public, parameter :: cone  = dcmplx(0.0_dp, 1.0_dp)
     complex(dp), public, parameter :: zone  = dcmplx(1.0_dp, 0.0_dp)
